...
:: --------------------------------------------------------------------------------------------
SET MSSdk=%FS_ROOT%\program\develop\Platform SDK\Windows7
SET TARGETOS=WINNT
...
SET TARGET_CPU=
SET CurrentSdkVersion=
set _t=%temp%\setenv.cmd
echo @echo off>%_t%
echo SET VCINSTALLDIR=%VCINSTALLDIR%>>%_t%
echo SET PATH=%PATH%>>%_t%
echo set SDKSETUPDIR=%SDKSETUPDIR%>>%_t%
echo set SDKTOOLS=%SDKTOOLS%>>%_t%
echo set INCLUDE=%INCLUDE%>>%_t%
echo set LIB=%LIB%>>%_t%
echo set CPU=%CPU%>>%_t%
echo set APPVER=%APPVER%>>%_t%
echo set FXTOOLS=%FXTOOLS%>>%_t%
echo set MSSDK=%MSSDK%>>%_t%
echo echo SET VCINSTALLDIR=%VCINSTALLDIR%>>%_t%
echo echo SET PATH=%PATH%>>%_t%
echo echo set SDKSETUPDIR=%SDKSETUPDIR%>>%_t%
echo echo set SDKTOOLS=%SDKTOOLS%>>%_t%
echo echo set INCLUDE=%INCLUDE%>>%_t%
echo echo set LIB=%LIB%>>%_t%
echo echo set CPU=%CPU%>>%_t%
echo echo set APPVER=%APPVER%>>%_t%
echo echo set FXTOOLS=%FXTOOLS%>>%_t%
echo echo set MSSDK=%MSSDK%>>%_t%
ENDLOCAL
